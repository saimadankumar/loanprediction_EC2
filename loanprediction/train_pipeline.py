...
from loanprediction.pipeline import loanprediction_pipe
from loanprediction.processing.data_manager import load_dataset, save_pipeline
...
def run_training() -> None:
    ...
    # Pipeline fitting
    loanprediction_pipe.fit(X_train, y_train)
    y_pred = loanprediction_pipe.predict(X_test)

    # Calculate the score/error
    result = "Default" if y_pred[0] == 1 else "No Default"
    print("result", result)
    ...
    save_pipeline(pipeline_to_persist = loanprediction_pipe)
